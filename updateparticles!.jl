function updateparticles!(X::Array{Float64}, par::Array{Float64}, velo::Array{Float64}, nx::Int64, ny::Int64, x1::Int64, x2::Int64, y1::Int64, y2::Int64, rad::Float64)
	#=
	    This function updates the set of particles using the velocity field.
	    	...
	    	ANNOTATIONS:
                ...
                Only useful for square domains, modify in other case.
	=#
